...
export const metadata: Metadata = {
  title: 'StayCool Airco Landgraaf | #1 in Airconditioning ✓',
  description: 'Dé airco specialist van Landgraaf! Professionele airco installatie voor woning en bedrijf door StayCool Airco. ✓ Gratis offerte ✓ Erkend installateur ✓ Alle topmerken ✓ 5 jaar garantie. Bel: 046 202 1430',
  alternates: {
